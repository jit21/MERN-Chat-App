...
const fatchChats=asyncHandler(async (req,res)=>{
    try {
...
const createGroupChat=asyncHandler(async(req,res)=>{
    if(!req.body.users || !req.body.name){
        return res.status(400).send({message:"please all of the field "});
    }
...
module.exports={accessChat,fatchChats,createGroupChat,renameGroup,addToGroup,removeFromGroup};